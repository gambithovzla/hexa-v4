...
export default function AnalysisPanel({
  ...
  useEffect(() => {
    if ((sport === 'nba' || sport === 'nfl' || sport === 'nhl' || sport === 'tennis') && modelMode === 'safe') {
      setModelMode('deep');
    }
  }, [sport, modelMode]);
  ...
  async function runAnalysis() {
    ...
    try {
      ...
      if (modelMode === 'safe') {
        if (sport === 'nba' || sport === 'nfl' || sport === 'nhl' || sport === 'tennis') {
  ...
  function extractHexaData(response) {
    const isHexa = (obj) =>
      ...
      (obj.master_prediction || obj.best_pick || obj.oracle_report || obj.parlay || obj.games || obj.safe_pick ||
