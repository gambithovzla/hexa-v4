/**
 * OracleLoadingOverlayClassic — cyber terminal loading (Classic brand).
 */
...
export default function OracleLoadingOverlayClassic({ lang = 'en' }) {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '5px' }}>
        <Typography sx={{
          fontFamily: MONO, fontSize: { xs: '1.05rem', sm: '1.25rem' }, fontWeight: 700,
          letterSpacing: '0.34em', color: C.textPrimary, lineHeight: 1,
        }}>
          H.E.X.A.
        </Typography>
        <Typography sx={{
      ...
      <Typography
        key={msgIndex}
        sx={{
          fontFamily: MONO, fontSize: { xs: '0.68rem', sm: '0.78rem' }, color: C.accent,
          letterSpacing: '0.1em', textTransform: 'uppercase', textAlign: 'center',
          px: '24px', maxWidth: 340,
          '@keyframes fadeInMsg': {
      ...
      <Box sx={{
        width: { xs: '220px', sm: '300px' }, height: '2px', bgcolor: C.border,
      ...
      <Typography sx={{
        fontFamily: MONO, fontSize: '0.48rem', letterSpacing: '0.2em',
