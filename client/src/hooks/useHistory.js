...
function dbRowToEntry(row) {
  ...
  return {
    ...
    hexa_hunch:           row.hexa_hunch ?? null,
...
export default function useHistory() {
  ...
  async function addPick(payload) {
    ...
    const body = {
      ...
      oracle_report:     mp.oracle_report ?? hexaData?.oracle_report ?? (sp ? sp.reasoning : null) ?? null,
      hexa_hunch:        mp.hexa_hunch ?? hexaData?.hexa_hunch ?? null,
