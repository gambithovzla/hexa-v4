...
- **Criterio de éxito**: ✅ contexto soccer con bloques LINEUP/INJURIES, VENUE/WEATHER, HEAD-TO-HEAD + REFEREE, SCHEDULE/CONGESTION, HOME/AWAY SPLIT y STAKES/MOTIVATION; `context_meta.completeness` rebalanceada; data depth ≥8.5 (núcleo cubierto, queda profundidad estadística avanzada FBref/xG-rolling).
