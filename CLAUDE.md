...
- **Pendiente operacional**: Parlay/Imperdible multi-sport (Fase 3 — motor frozen, requiere wrappers + temporada para validar); `NFL_LIVE_TRACKER_ENABLED`. Entrenamiento real del modelo `nfl_prop` + validación E2E requieren temporada (sept 2026, sin data viva en off-season).
