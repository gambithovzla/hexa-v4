...
- **Pendiente operacional**: `hexaNflBoardService.js` (sept 2026); Parlay/Imperdible multi-sport (Fase 3); `NFL_LIVE_TRACKER_ENABLED`; UI del board de props (extender `PlayerPropsPage` a `sport=nfl`). Entrenamiento real del modelo `nfl_prop` + validación E2E requieren temporada (sept 2026, sin data viva en off-season).
