...
- **11.3** profundidad de contexto pregame: 🟡 **lineups/injuries/suspensiones** ✅ ([soccer-lineups-api.js](server/soccer-lineups-api.js), API-Football api-sports.io, `API_FOOTBALL_KEY`); pendiente: árbitro, congestión de calendario, weather, FBref (PPDA/pases progresivos), xG rolling, motivación.
