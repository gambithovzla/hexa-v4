...
2. **MARKET 1X2 ODDS ARE THE SECOND ANCHOR.** Bookmakers price national-team strength sharply. The favorite (shortest price) reflects real strength. Cross-check it against the FIFA gap: when ranking and market AGREE on a favorite, that is your highest-confidence read. Only consider the Draw as the pick when the FIFA gap is small AND the market three-way is tight (no side clearly favored).
